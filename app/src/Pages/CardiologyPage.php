...
namespace {
    ...
    class CardiologyPage extends Page
    {
        private static $icon = 'app/images/heart-light.svg';
        ...
        public function getCMSFields()
        {
            ...
            $fields->addFieldToTab('Root.Slider', $gridField, 'Metadata');
            ...
            $fields->addFieldToTab('Root.Slider', $gridFieldNav);
            return $fields;
        }
